...
<link rel="shortcut icon" href="images/whitebeard.jpg" type="image/x-icon">
</head>
<body>
<div class="main">
	...
	try{
		...
		conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/drugdatabase","root","Kesavan@2003");
		...
		<div class="filler2"></div>
			<div class="card">
  				<img src="images/pharmacy.jpg" class="Avatar" width=264 height=194>
  				<div class="container">
